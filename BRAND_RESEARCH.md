...
> Snapshot as of **2026-07-28**: **81 of 132** brands verified — `&` and `A` (2026-07-24), `B`, `C`, `D`+`E`, `F`+`G` (2026-07-25), `H`, `I`+`J` (2026-07-26), `K` (2026-07-27), `L`+`M` (2026-07-28). Next group is **`N`** (2) — small, so batch it with `O` (3). This line is a convenience only; the query above is authoritative and self-correcting.
