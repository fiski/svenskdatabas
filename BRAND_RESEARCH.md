...
> Snapshot as of **2026-07-29**: **100 of 131** brands verified — `&` and `A` (2026-07-24), `B`, `C`, `D`+`E`, `F`+`G` (2026-07-25), `H`, `I`+`J` (2026-07-26), `K` (2026-07-27), `L`+`M`, `N` (2026-07-28), `O`, `P`, `R` and 3 of `S` (2026-07-29). Next is **`S` wave 2**, 14 brands. This line is a convenience only; the query above is authoritative and self-correcting.
